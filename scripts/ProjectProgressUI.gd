...
func setup(data):
	...
	if typeof(prog) == TYPE_DICTIONARY:
		programming.setup(preload("res://assets/sprites/icons/Code.png"), prog["target"], "Programming")
		programming.set_progress(prog["current"])
		design.setup(preload("res://assets/sprites/icons/Design.png"), des["target"], "Design")
		design.set_progress(des["current"])
		testing.setup(preload("res://assets/sprites/icons/Bug.png"), test["target"], "Testing")
		testing.set_progress(test["current"])
	else:
		programming.setup(preload("res://assets/sprites/icons/Code.png"), 20, "Programming")
		programming.set_progress(prog)
		design.setup(preload("res://assets/sprites/icons/Design.png"), 20, "Design")
		design.set_progress(des)
		testing.setup(preload("res://assets/sprites/icons/Bug.png"), 20, "Testing")
